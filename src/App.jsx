...
function Inventory() {
  ...
  const handleSave = async () => {
    ...
    try {
      const url    = editItem ? `https://backend-repo-psi.vercel.app/api/inventory/${editItem.id}` : 'https://backend-repo-psi.vercel.app/api/inventory';
  ...
  const handleDelete = async (id) => {
    ...
    setDeleting(id);
    try { await fetch(`https://backend-repo-psi.vercel.app/api/inventory/${id}`, { method:'DELETE', headers }); fetchItems(); }
